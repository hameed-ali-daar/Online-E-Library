    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="#" data-toggle="collapse"><i class="fa fa-fw fa-book"></i> Borrowed Books </a> 
                </li>
                <li>
                    <a href="requestlist.php" data-toggle="collapse"><i class="fa fa-fw fa-book"></i>  New Requests </a>
                </li>
                <li>
                    <a href="userdata.php" data-toggle="collapse" style="background-color:#7acbcd; color:white;"><i class="fa fa-fw fa-users"></i>  All Users </a>
                </li>
                <li>
    ...
    <form action="./Requestlist.php" method="POST">
      ...
      ?>
        ...
        <div class="alert alert-info alert-dismissible mt-2" style="margin-top:1%;" role="alert">
            ...
            <strong>Note !</strong> The way to get started is to quit talking and begin doing.
        </div>
      </div>
    </div>
</div>
