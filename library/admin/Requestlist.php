    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="requestlist.php" data-toggle="collapse" style="background-color:#7acbcd; color:white;"><i class="fa fa-fw fa-book"></i>  New Requests </a>
                </li>
                <li>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                    <h1>All request data from users.</h1>
                </div>
            </div>
            <!-- /.row -->
        </div>
    ...
    <form action="./Requestlist.php" method="POST">
      ...
      <table class="table table-bordered">
        ...
        <tr class="center">
            ...
            <td class="text-center">
                <a type="submit" href="?req_id=<?php echo $row['req_id'];?>" name="approve" class="btn btn-success">Approve</a>
                <a  class="btn btn-danger">Decline Request</a>
            </td>
        </tr>   
      ...
      if (isset($_GET['req_id'])) {
        ...
        if ($row = mysqli_fetch_array($result)) {
            $uName = $row['uName'];
            $rDate = date('Y/m/d');
            $finalDate = date('Y-m-d', strtotime('+1 week', strtotime($rDate)));
            $rStatus = '';
    
            $sql = "UPDATE `book_request` SET `rStatus` = 'Approved', `rDate` = '$rDate', `finalDate` = '$finalDate' WHERE `req_id` = '$req_id' AND `uName`='$uName'";
            $result = mysqli_query($conn, $sql);
      ...
      ?>
        ...
        <div class="alert alert-info alert-dismissible mt-2" style="margin-top:1%;" role="alert">
            ...
            <strong>Note !</strong> Are you want to Accept or Decline.....
        </div>
      </div>
    </div>
</div>
