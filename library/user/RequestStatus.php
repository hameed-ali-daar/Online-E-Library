    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="requestStatus.php" data-toggle="collapse" style="background-color:#7acbcd; color:white;"><i class="fa fa-fw fa-link"></i> Status of Request </a> 
                </li>
                <li>
      ...
      <table class="table table-bordered">
        <thead>
          ...
          <tbody>
            ...
            Initial Date :(<?php echo $info['rDate']?>) <br> Return Date :(<?php echo $info['finalDate']?>) 
            </td>
        </tr>   
    <?php } ?>
      </div>
